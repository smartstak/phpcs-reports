<?php
/**
 * Main wpsyncsheets-elementor namespace.
 *
...
/**
 * WPSSLE Dependency Checker
 */
class WPSSLE_Dependencies {
	/**
	 * Active plugins
	 *
	 * @var $active_plugins
	...
	public static function init() {
		if ( is_multisite() ) {
			...
			// Check Elementor active at the network site.
			if ( is_plugin_active_for_network( 'elementor-pro/elementor-pro.php' ) ) {
				self::$active_plugins = (array) get_site_option( 'active_sitewide_plugins', array() );
			} else { // Check Elementor active at the network individual site.
	...
	/**
	 * Check Elementor exist
	 *
	 * @return Boolean
	 */
	public static function wpssle_elementor_active_check() {
		if ( ! self::$active_plugins ) {
			self::init();
		}
		if ( in_array( 'elementor-pro/elementor-pro.php', self::$active_plugins, true ) || array_key_exists( 'elementor-pro/elementor-pro.php', self::$active_plugins ) ) {
	 ...
	 * @return Boolean
	 */
	public static function wpssle_is_elementor_plugin_active() {
		return self::wpssle_elementor_active_check();
	}
