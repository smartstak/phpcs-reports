...
namespace WPSyncSheetsElementor {
	...
	final class WPSyncSheetsElementor {
		...
		private function includes() {
			...
			require_once WPSSLE_PATH . '/includes/class-wpssle-assets-url.php'; // Changed.
			require_once WPSSLE_PATH . '/includes/class-wpssle-plugin-setting.php';
			require_once WPSSLE_PATH . '/includes/class-wpssle-notifications.php';
			require_once WPSSLE_PATH . '/feedback/users-feedback.php';
		}
	}
}
