...
class WPSSLGF_UsersFeedback {

	private $plugin_url         = WPSSLGF_URL; // Change - Not in Use.
	private $plugin_version     = WPSSLGF_VERSION; // Changed - Better to sue CONSTANT for single soruce of truth.
	private $plugin_name        = 'WPSyncSheets Lite For Gravity Forms';
	private $plugin_slug        = 'wpssg';
	private $plugin_download_id = WPSSLGF_PLUGIN_ITEM_ID;
	/*
	|-----------------------------------------------------------------|
				...
				<div class="<?php echo $this->plugin_slug; ?>-deactivation-response">
					<div id="<?php echo $this->plugin_slug; ?>-deactivate-feedback-dialog-header">
						<div class="<?php echo $this->plugin_slug; ?>-form-title--icon-wrapper">
							...
							<h2 class="<?php echo $this->plugin_slug; ?>-title"><?php echo esc_html( __( 'Quick Feedback', 'wpssg' ) ); ?></h2>
						</div>
					...
					<div id="<?php echo $this->plugin_slug; ?>-loader-wrapper">
						<div class="<?php echo $this->plugin_slug; ?>-loader-container">
								<img class="<?php echo $this->plugin_slug; ?>-preloader" src="<?php echo WPSSLGF_URL; ?>feedback/images/preloader.gif">
						</div>
					</div>
					<div id="<?php echo $this->plugin_slug; ?>-form-wrapper" class="<?php echo $this->plugin_slug; ?>-form-wrapper-cls">
						<form id="<?php echo $this->plugin_slug; ?>-deactivate-feedback-dialog-form" method="post">
							...
							<div id="<?php echo $this->plugin_slug; ?>-deactivate-feedback-dialog-form-caption"><?php echo esc_html( __( 'If you have a moment, please share why you are deactivating this plugin.', 'wpssg' ) ); ?></div>
							<div id="<?php echo $this->plugin_slug; ?>-deactivate-feedback-dialog-form-body">
									...
									<div class="<?php echo $this->plugin_slug; ?>-deactivate-feedback-dialog-input-wrapper">
										...
										<?php if ( ! empty( $reason['input_placeholder'] ) ) : ?>
											...
											if ( in_array( $reason_key, $reason_key_arr, true ) ) {
												$twae_plugin_url = 'https://wordpress.org/plugins/wpsyncsheets-gravity-forms/';
											}
										endif;
										?>
								...
								<?php endforeach; ?>
								<input class="<?php echo $this->plugin_slug; ?>-GDPR-data-notice" id="<?php echo $this->plugin_slug; ?>-GDPR-data-notice" type="checkbox"><label for="<?php echo $this->plugin_slug; ?>-GDPR-data-notice"><?php echo esc_html( __( 'I consent to WPSyncSheets plugins collecting all the information I submit through this form and using it to respond to my inquiry.', 'wpssg' ) ); ?></label>
							...
							<div class="<?php echo $this->plugin_slug; ?>-plugin-popup-button-wrapper">
								<a class="<?php echo $this->plugin_slug; ?>-button " id="<?php echo $this->plugin_slug; ?>-plugin-submitNdeactivate"><?php echo esc_html__( 'Submit and Deactivate', 'wpssg' ); ?></a>
								<a class="<?php echo $this->plugin_slug; ?>-button" id="<?php echo $this->plugin_slug; ?>-plugin-skipNdeactivate"><?php echo esc_html__( 'Skip and Deactivate', 'wpssg' ); ?></a>
							</div>
						</form>
					</div>
				</div>
	...
	public function get_deactivate_reasons_arr(){
		$deactivate_reasons = array(
			'didnt_work_as_expected'         => array(
				'title'             => esc_html( __( 'The plugin didn\'t work as expected', 'wpssg' ) ),
				'input_placeholder' => esc_html( __( 'What did you expect?', 'wpssg' ) ),
			),
			'found_a_better_plugin'          => array(
				'title'             => esc_html( __( 'I found a better plugin', 'wpssg' ) ),
				'input_placeholder' => esc_html( __( 'Please share which plugin', 'wpssg' ) ),
			),
			'couldnt_get_the_plugin_to_work' => array(
				'title'             => esc_html( __( 'The plugin is not working', 'wpssg' ) ),
				'input_placeholder' => esc_html( __( 'Please share your issue. So we can fix that for other users.', 'wpssg' ) ),
			),
			'temporary_deactivation'         => array(
				'title'             => esc_html( __( 'It\'s a temporary deactivation', 'wpssg' ) ),
				'input_placeholder' => '',
			),
			'other'                          => array(
				'title'             => esc_html( __( 'Other', 'wpssg' ) ),
				'input_placeholder' => esc_html( __( 'Please share the reason', 'wpssg' ) ),
			),
		);
		return $deactivate_reasons;
	}
}
new WPSSLGF_UsersFeedback();