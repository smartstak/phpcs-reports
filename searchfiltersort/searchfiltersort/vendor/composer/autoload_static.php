...
class ComposerStaticInit7e972a688c38aaccebac33b0bedd76f4
{
    ...
    public static $classMap = array (
        ...
        'SearchFilterSort\\SFLTS_Ajax' => __DIR__ . '/../..' . '/includes/SFLTS_Ajax.php',
        'SearchFilterSort\\SFLTS_Assets' => __DIR__ . '/../..' . '/includes/SFLTS_Assets.php',
        'SearchFilterSort\\SFLTS_Assets_URL' => __DIR__ . '/../..' . '/includes/SFLTS_Assets_URL.php',
        'SearchFilterSort\\SFLTS_CPT' => __DIR__ . '/../..' . '/includes/SFLTS_CPT.php',
        'SearchFilterSort\\SFLTS_Helpers' => __DIR__ . '/../..' . '/includes/SFLTS_Helpers.php',
        'SearchFilterSort\\SFLTS_Plugin' => __DIR__ . '/../..' . '/includes/SFLTS_Plugin.php',
        'SearchFilterSort\\SFLTS_Query' => __DIR__ . '/../..' . '/includes/SFLTS_Query.php',
        'SearchFilterSort\\SFLTS_Settings' => __DIR__ . '/../..' . '/includes/SFLTS_Settings.php',
        'SearchFilterSort\\SFLTS_Shortcode' => __DIR__ . '/../..' . '/includes/SFLTS_Shortcode.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit7e972a688c38aaccebac33b0bedd76f4::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit7e972a688c38aaccebac33b0bedd76f4::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit7e972a688c38aaccebac33b0bedd76f4::$classMap;
